...
const DetailInfoDialogApp: React.FC = () => {
  ...
  return (
    <div className="absolute top-[200px] right-0 p-4 z-10">
      <div className="relative  md:w-[50vw] w-[85vw]">
        <DialogHeader
          text="交通情報"
          icon="close"
          variant="header-dark"
          ...
          isShadow={false}
        />
        <div className="h-[60vh] md:w-[50vw] w-[85vw] bg-white rounded-b-lg shadow-md shadow-black overflow-y-auto no-scrollbar">
          <TitleInfoCard
            text="都営地下鉄　運行情報"
