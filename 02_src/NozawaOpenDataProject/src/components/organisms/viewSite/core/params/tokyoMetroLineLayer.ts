...
const tokyoMetroLayer: LayerType = {
  ...
  paint: {
    "line-color": [
      ...
      "3号線銀座線", "#FF9500", // 銀座線の場合の色
      "4号線丸ノ内線", "#F62E36", // 丸ノ内線の場合の色
      "4号線丸ノ内線分岐線", "#F62E36", // 丸ノ内線の場合の色
      "2号線日比谷線", "#B5B5AC", // 日比谷線の場合の色
      "5号線東西線", "#009BBF", // 東西線の場合の色
      "9号線千代田線", "#00BB85", // 千代田線の場合の色
      "8号線有楽町線", "#C1A470", // 有楽町線の場合の色
      "11号線半蔵門線", "#8F76D6", // 半蔵門線の場合の色
      "7号線南北線", "#00AC9B", // 南北線の場合の色
      "13号線副都心線", "#9C5E31", // 副都心線の場合の色
