...
import { HELLO_CYCLE_LAYER, DOCOMO_BIKE_SHARE_LAYER } from "@/domain/params/customLayerName"

/**
 * サイクルレイヤー管理のインフラストラクチャ
 * @returns
 */
const useMapCycleLayer = (): IMapCycleLayer => {
...
export default useMapCycleLayer
